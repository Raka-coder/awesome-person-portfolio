...
export const sampleProjects: Project[] = [
  {
    ...
    description:
      "Web application that can be used to calculate population modeling with geometric series",
    longDescription:
    ...
    links: [
      {
        type: "github",
        url: "https://github.com/Raka-coder/project-geometpop-kalkulus-II",
        label: "View Code",
      },
  ...
  },
  {
    ...
    description:
      "Web application that can be used to calculate diferential derivative",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Simple CRUD task management application with supabase serverless backend database.",
    longDescription: "A simple CRUD task manager.",
    categories: [
      projectCategories[0], // Web App
      projectCategories[1],
    ],
    links: [
      {
        type: "github",
        url: "https://github.com/Raka-coder/react-supabase-crud-taskmanager",
        label: "View Code",
      },
      {
        type: "demo",
        url: "https://react-supabase-crud-taskmanager.vercel.app/",
        label: "Try Demo",
      },
    ],
  ...
  },
  {
    ...
    name: "Smart Home IoT",
    description:
      "A smart home IoT project with lighting control, and assistant.",
    longDescription:
    ...
    links: [
      {
        type: "github",
        url: "https://github.com/Raka-coder/project-smarthome-pio",
        label: "View Code",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Personal portfolio website built with Next.js featuring animated motion and responsive design.",
    longDescription:
    ...
    links: [
      {
        type: "github",
        url: "https://github.com/ahmadrizki/portfolio",
        label: "View Code",
      },
